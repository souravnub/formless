          ...
          <form className="space-y-3 pr-5">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create all the fields that are needed in this form
                </CardDescription>
              </CardHeader>
              ...
              <CardContent>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="center">
                    ...
                    <DropdownMenuItem
                      onClick={() => setIsRadioDialogOpen(true)}
                    >
                      Radio Buttons
                    </DropdownMenuItem>
                    <DropdownMenuItem
                      onClick={() => setIsCheckboxDialogOpen(true)}
                    >
                      Checkboxes
                    </DropdownMenuItem>

                    <DropdownMenuItem
                      onClick={() => setIsDesicionFieldDialogOpen(true)}
                    >
                      Decision Fields
                    </DropdownMenuItem>

                    <DropdownMenuItem
                      onClick={() => setIsDecisionCommentDialogOpen(true)}
                    >
                      Decision & Comment
                    </DropdownMenuItem>
                  </DropdownMenuContent>
